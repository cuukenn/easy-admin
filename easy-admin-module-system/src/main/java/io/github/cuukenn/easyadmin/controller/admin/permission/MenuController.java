...
public class MenuController {
	...
	@GetMapping("/list")
	public ApiResult<List<MenuResVo>> list(@Valid MenuListReqVo vo) {
		List<MenuDto> list = service.list(vo);
		list.sort(Comparator.comparing(MenuDto::getNumber));
		return ApiResult.success(MenuConverter.INSTANCE.toMenuResVo(list));
	}
