...
public class DynamicMongoAnnotationAdvisor extends AbstractPointcutAdvisor implements BeanFactoryAware {
	...
	public DynamicMongoAnnotationAdvisor(@NonNull MethodInterceptor advice,
	...
	private static class AnnotationMethodPoint implements Pointcut {
		...
		private static class AnnotationMethodMatcher extends StaticMethodMatcher {
			private static final Logger logger = LoggerFactory.getLogger(AnnotationMethodMatcher.class);
			private final Class<? extends Annotation> annotationType;
			...
			public boolean matches(Method method, Class<?> targetClass) {
				if (logger.isDebugEnabled()) {
					logger.debug("dynamic annotation matches for {}.{}", method.getName(), targetClass.getName());
				}
